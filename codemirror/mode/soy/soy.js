            ...
            return {
                ...
                copyState: function (state) {
                    return {
                        ...
                        localStates: state.localStates.map(
                            function (localState) {
                                return {
                ...
                token: function (stream, state) {
                    ...
                    switch (last(state.soyState)) {
                        ...
                        case "import":
                            ...
                            if ((match = stream.match(/\w+/))) {
                                return /\b(from|as)\b/.test(match[0])
                                    ? "keyword"
                                    : "def";
                            }
                            if ((match = stream.match(/^["']/))) {
