...
(function () {
    ...
    MT(
        "extern",
        "[keyword {extern] [def renderer]: ([def s]:[type string])=>[type string][keyword }] [keyword {/extern}]",
    );

    MT(
        "export extern",
        "[keyword {export] [keyword extern] [def renderer]: ([def s]:[type string])=>[type string][keyword }] [keyword {/extern}]",
    );
